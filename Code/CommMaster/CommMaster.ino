...
void loop() {
  ...
  case 'r':
    ...
    Serial.println("Launch Ready is " + launchReady);
    break;
  case 'f':
    finalLaunchReady = !finalLaunchReady;
    Serial.println("Final Launch Ready is " + finalLaunchReady);
    break;
  case 'l':
    ...
    break;
  case 's':
    Serial.println("Laucnh Ready is: " + String(launchReady, DEC) + " Second Launch Ready is: " + String(finalLaunchReady, DEC));
